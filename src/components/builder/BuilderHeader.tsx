      ...
      <div className="mx-auto flex max-w-[1800px] flex-col gap-3">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          <div className="min-w-0 space-y-3">
            ...
            <p className="flex flex-wrap items-center gap-2 text-xs font-medium text-slate-600">
              <span className="rounded-md border border-slate-200 bg-slate-50 px-2 py-1">Developed by {APP_DEVELOPER.name}</span>
              <a
                className="inline-flex min-h-7 items-center gap-1 rounded-md border border-slate-200 bg-white px-2 text-sky-800 underline-offset-2 hover:border-sky-200 hover:bg-sky-50 hover:underline focus:outline-none focus:ring-2 focus:ring-sky-200"
        ...
        <div aria-label="Resume actions" className="flex flex-wrap gap-2 rounded-lg border border-slate-200 bg-slate-50 p-2">
