...
import { createBlankCertification, createBlankLink } from "@/lib/resume/defaults";
...
export function CertificationsForm() {
  ...
  return (
    <SectionCard actions={<Button icon={<Plus aria-hidden size={16} />} onClick={() => setItems([...items, createBlankCertification()])} size="sm">Add certification</Button>} description="Certification links are exported by label when valid." title="Certifications">
